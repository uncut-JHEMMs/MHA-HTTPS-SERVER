...
echo "plot 'cpu_usage_log.csv' using 1:2 title 'input_usage' with lines lt 1 lw 3, 'cpu_usage_log.csv' using 1:3 title 'write_usage' with lines lt 2 lw 1" >> GNUPLOT
